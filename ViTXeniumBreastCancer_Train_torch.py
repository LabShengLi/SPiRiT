...
MyVit.patch_size = 12  # Size of the patches to be extract from the input images 
...
torch.save(model, "saved_models/ViT_pretrained_XeniumBreastCancerData_"+data_set+".pt")
...
pth = 'output/logs/logVitPretrained_Xenium.json'
import json
